...
class BNO055:
    ...
    Application notes:
        This thing is only happy at a baudrate of 1000. Something in init is bad, but making actual i2c calls to the BNO055
        using the registers mapped out in here just works.
        The operation mode still needs to be set, also. It'll just return all x00's for its data without that step.
    """
